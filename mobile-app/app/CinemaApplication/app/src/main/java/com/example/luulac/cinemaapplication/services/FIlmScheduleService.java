...
public interface FIlmScheduleService {
    ...
    Call<ShowTimeListModel> getScheduleForChangeTicket(@Query("cinemaId") int cinemaId, @Query("indexDate") int indexDate,
                                                       @Query("filmId") int filmId,@Query("scheduleId") int scheduleId);
}
