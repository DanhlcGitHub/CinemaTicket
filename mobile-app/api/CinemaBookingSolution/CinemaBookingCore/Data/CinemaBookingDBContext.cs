    ...
    public partial class CinemaBookingDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer(@"data source=DESKTOP-58U8RAL\SQLEXPRESS;initial catalog=CinemaBookingDBFinal;user id=sa;password=nghich;MultipleActiveResultSets=True;");
            }
        }
