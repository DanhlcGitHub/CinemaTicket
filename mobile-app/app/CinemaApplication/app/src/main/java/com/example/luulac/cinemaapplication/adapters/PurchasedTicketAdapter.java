...
public class PurchasedTicketAdapter extends RecyclerView.Adapter<PurchasedTicketAdapter.PurchasedTicketHolder> {
    ...
    public void onBindViewHolder(final @NonNull PurchasedTicketHolder holder, final int position) {
        ...
        Glide.with(context).load(data.get(position).getQrCode()).into(holder.imgTicketQrCode);
        ...
        if (data.get(position).isCanChange() == false) {
            holder.btnChangeTicket.setVisibility(View.GONE);
            holder.btnResellTicket.setVisibility(View.GONE);
        }
    ...
    public void confirmResellTicket(final int ticketId) {
        ...
        new AlertDialog.Builder(context)
                ...
                .setMessage("Nhập miêu tả cho vé này.")
