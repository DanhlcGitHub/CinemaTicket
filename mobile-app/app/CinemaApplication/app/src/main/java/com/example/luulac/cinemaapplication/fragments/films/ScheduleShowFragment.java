...
public class ScheduleShowFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<List<FilmScheduleModel>> request = service.getScheduleByDayAndFilmId(filmdId, 0);
                ...
                recyclerView.addOnItemTouchListener(
                        new RecyclerItemClickListener(context, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                FIlmScheduleService service = ServiceBuilder.buildService(FIlmScheduleService.class);
                                Call<List<FilmScheduleModel>> request = service.getScheduleByDayAndFilmId(filmdId, position);
                    ...
                    public void renderChild(View view, ShowTimeChildModel model, int parentPosition, int childPosition) {
                        ...
                        view.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                SharedPreferences sharedPreferences = context.getSharedPreferences("loginInformation", Context.MODE_PRIVATE);
                                ...
                                if(userId != ""){
                                    ...
                                    Toast.makeText(context, "Bạn vui lòng đăng nhập trước khi đặt vé!", Toast.LENGTH_SHORT).show();
                                }
